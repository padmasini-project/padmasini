...
const Jee = () => {
  ...
  useEffect(() => {
    ...
    if (storedUser) {
      ...
      if (storedUser.standard === "both") {
        const savedClass = sessionStorage.getItem("currentClassJee") || "";
    ...
    const savedCompletion = JSON.parse(sessionStorage.getItem("jeeSubjectCompletion"));
    if (savedCompletion) {
  ...
  const handleClassChange = (e) => {
    ...
    sessionStorage.setItem("currentClassJee", selected);
  };
  ...
  const handleSubjectCompletion = (subjectName) => {
    ...
    sessionStorage.setItem("jeeSubjectCompletion", JSON.stringify(updatedSubjects));
  };

  useEffect(() => {
    const completedSubtopics = JSON.parse(sessionStorage.getItem("jeeCompletedSubtopics"));
    if (
      completedSubtopics &&
