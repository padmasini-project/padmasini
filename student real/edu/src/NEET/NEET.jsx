...
const Subjects = () => {
  ...
  useEffect(() => {
    ...
    if (storedUser) {
      ...
      if (storedUser.standard === "both") {
        const savedClass = sessionStorage.getItem("currentClass") || "";
    ...
    const savedCompletion = JSON.parse(sessionStorage.getItem("subjectCompletion"));
    if (savedCompletion) {
  ...
  const handleSubjectCompletion = (subjectName) => {
    ...
    sessionStorage.setItem("subjectCompletion", JSON.stringify(updatedSubjects));
  };

  useEffect(() => {
    const completedSubtopics = JSON.parse(sessionStorage.getItem("completedSubtopics"));
    if (
      completedSubtopics &&
  ...
  const handleClassChange = (e) => {
    ...
    sessionStorage.setItem("currentClass", selected);
  };
