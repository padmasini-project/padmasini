...
>
  ...
  {/* here i have give alignment for description */}
...
<h4>{selectedSubtopic ? 'Add Child Subtopic' : 'Add Subtopic'}</h4>
    ...
    <div className="formula-hint">
      ...
      >
<FaLightbulb size={20} style={{ marginRight: "8px", color: "#f39c12" }} />
        <span style={{ fontWeight: "bold" }}>Formula Hint</span>
      </div>

      {showHint && (
  <div className="hint-content" style={{ marginTop: "10px", padding: "10px", background: "#f9f9f9", borderRadius: "8px" }}>
    <p style={{ margin: 0, fontStyle: "italic", color: "#555" }}>
      💡 Example Hint: <br />
      The formula for the area of a circle is <b>A = πr²</b>. <br />
      Remember: π ≈ 3.14159
    </p>
  </div>
)}
...
{editingQuestionIndex !== null && (
  ...
  >
    Cancel Edit
                ...
                {questions.length > 0 && (
                  <ol>
                     {/* Display list of added questions with format */}
  {questions.map((q, idx) => (
  <li key={idx} style={{ marginBottom: '10px' }}>
